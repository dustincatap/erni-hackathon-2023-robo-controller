...
import 'package:robo_controller/core/presentation/navigation/navigation_observer.dart';
import 'package:robo_controller/core/presentation/navigation/root_auto_router.dart';
import 'package:robo_controller/core/presentation/views/view_mixin.dart';
import 'package:robo_controller/core/service_locator.dart';
import 'package:robo_controller/presentation/app/view_models/app_view_model.dart';
...
class _AppState extends State<App> with ViewMixin<AppViewModel> {
  ...
  AppViewModel onCreateViewModel(BuildContext context) {
    ...
    unawaited(SystemChrome.setPreferredOrientations(<DeviceOrientation>[DeviceOrientation.landscapeLeft]));
